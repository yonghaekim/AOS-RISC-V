...
//val uopSRET = 40.U(UOPC_SZ.W)
  ...
  //yh+begin
  val uopPACMA     = 120.U(UOPC_SZ.W) 
  val uopXPACM     = 121.U(UOPC_SZ.W)
  val uopBNDSTR    = 122.U(UOPC_SZ.W)
  val uopBNDCLR    = 123.U(UOPC_SZ.W)
  val uopBNDSRCH   = 124.U(UOPC_SZ.W)
  //yh+end
  ...
  def NullMicroOp()(implicit p: Parameters): boom.common.MicroOp = {
    ...
    uop.uses_mcq   := false.B //yh+
    uop.uses_bdq   := false.B //yh+
    uop.pdst       := 0.U
    uop.dst_rtype  := RT_X
