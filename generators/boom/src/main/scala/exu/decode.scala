...
object MCUDecode extends DecodeConstants
{
  ...
  BNDSTR  -> List(Y, N, X, uopBNDSTR, IQT_INT, FU_ALU, RT_FIX, RT_FIX, RT_FIX, N, IS_X, N, N, N, N, N, M_X,   1.U, Y, N, N, N, N, CSR.N),
  BNDCLR  -> List(Y, N, X, uopBNDCLR, IQT_INT, FU_ALU, RT_FIX, RT_FIX, RT_X,   N, IS_X, N, N, N, N, N, M_X,   1.U, Y, N, N, N, N, CSR.N),
  BNDSRCH -> List(Y, N, X, uopBNDSRCH,IQT_INT, FU_ALU, RT_FIX, RT_FIX, RT_FIX, N, IS_X, N, N, N, N, N, M_X,   1.U, Y, N, N, N, N, CSR.N)
  //BNDSTR  -> List(Y, N, X, uopBNDSTR, IQT_MEM, FU_MEM, RT_X  , RT_FIX, RT_FIX, N, IS_X, N, N, N, N, N, M_X,   0.U,N, N, N, N, N, CSR.N),
  //BNDCLR  -> List(Y, N, X, uopBNDCLR, IQT_MEM, FU_MEM, RT_X  , RT_FIX, RT_X,   N, IS_X, N, N, N, N, N, M_X,   0.U,N, N, N, N, N, CSR.N),
  //BNDSRCH -> List(Y, N, X, uopBNDSRCH,IQT_MEM, FU_MEM, RT_FIX, RT_FIX, RT_FIX, N, IS_X, N, N, N, N, N, M_X,   3.U,N, N, N, N, N, CSR.N)
  )
}
//yh+end
