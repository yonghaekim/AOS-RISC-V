...
object AluRRdDecode extends RRdDecodeConstants
{
  val table: Array[(BitPat, List[BitPat])] =
         ...
         BitPat(uopSRLW)  -> List(BR_N , Y, N, N, FN_SR  , DW_32 , OP1_RS1 , OP2_RS2 , IS_X, REN_1, CSR.N),
				 ...
				 //yh+begin
         BitPat(uopPACMA) -> List(BR_N , Y, N, N, FN_PACMA,DW_XPR, OP1_RS1 , OP2_RS2 , IS_X, REN_1, CSR.N),
         BitPat(uopXPACM) -> List(BR_N , Y, N, N, FN_XPACM,DW_XPR, OP1_RS1 , OP2_X   , IS_X, REN_1, CSR.N),
         BitPat(uopBNDSTR)-> List(BR_N , Y, N, N, FN_BND , DW_XPR, OP1_RS1 , OP2_RS2 , IS_X, REN_1, CSR.N),
         BitPat(uopBNDCLR)-> List(BR_N , Y, N, N, FN_BND , DW_XPR, OP1_RS1 , OP2_X   , IS_X, REN_1, CSR.N),
         BitPat(uopBNDSRCH)->List(BR_N , Y, N, N, FN_BND , DW_XPR, OP1_RS1 , OP2_RS2 , IS_X, REN_1, CSR.N),
				 //yh+end
  ...
  with freechips.rocketchip.rocket.constants.MemoryOpConstants
{
  ...
  //yh-require (rrd_cs.op_fcn.getWidth == FN_SRA.getWidth)
