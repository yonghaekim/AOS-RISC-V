...
object XDecode extends DecodeConstants
{
  ...
  //yh+begin
  PACMA   -> List(Y, N, X, uopPACMA,  IQT_INT, FU_ALU, RT_FIX, RT_FIX, RT_FIX, N, IS_X, N, N, N, N, N, M_X,      1.U,Y, N, N, N, N, CSR.N),
  XPACM   -> List(Y, N, X, uopXPACM,  IQT_INT, FU_ALU, RT_FIX, RT_FIX, RT_X,   N, IS_X, N, N, N, N, N, M_X,      1.U,Y, N, N, N, N, CSR.N),
  //BNDSTR  -> List(Y, N, X, uopBNDSTR, IQT_INT, FU_ALU,  RT_FIX, RT_FIX, RT_FIX, N, IS_X, N, N, N, N, N, M_XRD,    0.U,N, N, N, N, N, N, N, CSR.N),
  //BNDCLR  -> List(Y, N, X, uopBNDCLR, IQT_INT, FU_ALU,  RT_FIX, RT_FIX, RT_X,   N, IS_X, N, N, N, N, N, M_XRD,    0.U,N, N, N, N, N, N, N, CSR.N),
  //BNDSRCH -> List(Y, N, X, uopBNDSRCH,IQT_INT, FU_ALU,  RT_FIX, RT_FIX, RT_FIX, N, IS_X, N, N, N, N, N, M_XRD,    0.U,N, N, N, N, N, N, N, CSR.N),
  BNDSTR  -> List(Y, N, X, uopBNDSTR, IQT_MEM, FU_MEM, RT_X  , RT_FIX, RT_FIX, N, IS_X, N, N, N, N, N, M_XRD,    3.U,N, N, N, N, N, CSR.N),
  BNDCLR  -> List(Y, N, X, uopBNDCLR, IQT_MEM, FU_MEM, RT_X  , RT_FIX, RT_X,   N, IS_X, N, N, N, N, N, M_XRD,    3.U,N, N, N, N, N, CSR.N),
  BNDSRCH -> List(Y, N, X, uopBNDSRCH,IQT_MEM, FU_MEM, RT_FIX, RT_FIX, RT_FIX, N, IS_X, N, N, N, N, N, M_XRD,    3.U,N, N, N, N, N, CSR.N),
  //yh+end
...
//     cs.div && !csr.io.status.isa('m'-'a') || TODO check for illegal div instructions
  ...
  //yh+begin
  uop.uses_mcq   := (io.enableWYFY &&
										(cs.uses_ldq || cs.uses_stq) &&
										!cs.is_fence && !cs.is_fencei)
  uop.uses_bdq   := ((cs.uopc === uopBNDSTR)
                      || (cs.uopc === uopBNDCLR)
                      || (cs.uopc === uopBNDSRCH))

  uop.is_bndload := false.B
  when (cs.uopc === uopPACMA)
  {
    printf("YH+ Found uopPACMA!\n")
  }
    .elsewhen (cs.uopc === uopXPACM)
  {
    printf("YH+ Found uopXPACM!\n")
  }
    .elsewhen (cs.uopc === uopBNDSTR)
  {
    printf("YH+ Found uopBNDSTR!\n")
  }
    .elsewhen (cs.uopc === uopBNDCLR)
  {
    printf("YH+ Found uopBNDCLR!\n")
  }
    .elsewhen (cs.uopc === uopBNDSRCH)
  {
    printf("YH+ Found uopBNDSRCH!\n")
  }
