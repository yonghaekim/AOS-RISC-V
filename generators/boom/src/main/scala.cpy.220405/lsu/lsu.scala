  ...
  with rocket.HasL1HellaCacheParameters
{
  ...
  //TODO val bdq_load_pac = bdq_load_e.bits.addr.bits(xLen-1,xLen-pacWidth)

  //TODO for (i <- 0 until numBdqEntries) {
  //TODO   val temp_pac = bdq(i).bits.addr.bits(xLen-1,xLen-pacWidth)

  //TODO   pac_match_bdq(i) := bdq_load_e.valid &&
  //TODO                 IsOlder(i.U, bdq_load_idx, bdq_head) &&
  //TODO                 (bdq(i).bits.state =/= b_done) &&
  //TODO                 (!bdq(i).bits.addr.valid ||
  //TODO                   temp_pac === bdq_load_pac)

  //TODO   when (bdq_load_e.valid && IsOlder(i.U, bdq_load_idx, bdq_head))
  //TODO   {
  //TODO     printf("YH+ [%d] pac_match_bdq bdq(%d): %d <-> bdq(%d): %d\n",
  //TODO             io.core.tsc_reg, i.U, temp_pac, bdq_load_idx, bdq_load_pac)
  //TODO   }
  //TODO }

  val bdq_load_val = (bdq_load_e.valid                      &&
                      bdq_load_idx === bdq_head             && //TODO
  ...
  //TODO val mcq_load_pac = mcq_load_e.bits.addr(xLen-1,xLen-pacWidth)
  //TODO val youngest_bdq_idx = mcq_load_e.bits.youngest_bdq_idx

  //TODO for (i <- 0 until numBdqEntries) {
  //TODO   val temp_pac = bdq(i).bits.addr.bits(xLen-1,xLen-pacWidth)

  //TODO   pac_match_mcq(i) := mcq_load_e.valid &&
  //TODO                 bdq(i).valid &&
  ...
  //TODO   when (mcq_load_e.valid && IsOlder(i.U, youngest_bdq_idx, bdq_head))
  //TODO   {
