  ...
  val table: Array[(BitPat, List[BitPat])] = Array(
    ...
    SW->        List(Y,N,N,N,N,N,Y,Y,N,A2_IMM, A1_RS1, IMM_S, DW_XPR,FN_ADD,   Y,M_XWR,      N,N,N,N,N,N,N,CSR.N,N,N,N,N),
		...
		//yh+begin
                ...
                //   | | | | | | | |   |       |       |      |      |         | |           | | | | | | wxd     | | amo
                //   | | | | | | | | scie      |       |      |      |         | |           | | | | | | |       | | | dp
		PACMA->			List(Y,N,N,N,N,N,Y,Y,N,A2_RS2, A1_RS1, IMM_X, DW_XPR,FN_PACMA, N,M_X,        N,N,N,N,N,N,Y,CSR.N,N,N,N,N),
		XPACM->			List(Y,N,N,N,N,N,N,Y,N,A2_X,   A1_RS1, IMM_X, DW_XPR,FN_XPACM, N,M_X,        N,N,N,N,N,N,Y,CSR.N,N,N,N,N),
		BNDSTR->	  List(Y,N,N,N,N,N,Y,Y,N,A2_RS2, A1_RS1, IMM_X, DW_XPR,FN_BND,   N,M_X,        N,N,N,N,N,N,Y,CSR.N,N,N,N,N),
		BNDCLR->	  List(Y,N,N,N,N,N,N,Y,N,A2_X,   A1_RS1, IMM_X, DW_XPR,FN_BND,   N,M_X,        N,N,N,N,N,N,Y,CSR.N,N,N,N,N),
		BNDSRCH->	  List(Y,N,N,N,N,N,Y,Y,N,A2_RS2, A1_RS1, IMM_X, DW_XPR,FN_BND,   N,M_X,        N,N,N,N,N,N,Y,CSR.N,N,N,N,N),
		//yh+end
